...
export function useAccountForm(accountId?: string) {
    ...
    const handleSave = async () => {
        ...
        const accountData = {
            ...
            interestPayoutDate: (formData.interestPayoutFrequency === 'annually' || formData.interestPayoutFrequency === 'at_maturity' || formData.interestPayoutFrequency === 'monthly') && formData.interestPayoutDate
