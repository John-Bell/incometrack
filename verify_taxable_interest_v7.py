        ...
        try:
            ...
            await page.evaluate("""
                async () => {
                    ...
                    // OwnerId should match person tabs: 'person1', 'person2', 'joint'
            ...
            screenshot_path = "/home/jules/verification/accounts_page_v7.png"
            await page.screenshot(path=screenshot_path)
            print(f"Screenshot saved to {screenshot_path}")

            print("Checking cards...")
            # Locator for the Taxable Savings card
            ...
            if await isa_taxable_label.is_visible():
                print("ISA card shows taxable interest label (unexpected since it should be 0 and we hide 0s in the component).")
                text = await isa_card.inner_text()
                print(f"ISA Card Content: {text}")
            else:
                print("ISA card does NOT show taxable interest label (correctly hidden as 0).")

        except Exception as e:
            print(f"An error occurred: {e}")
            await page.screenshot(path="/home/jules/verification/error_state_v7.png")
        finally:
            await context.tracing.stop(path="/home/jules/verification/trace_v7.zip")
            await browser.close()
